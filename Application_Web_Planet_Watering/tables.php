...
function convertToPercentage($analogValue) {
    return 100 - ($analogValue * 100 / 1023);
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $moisturePercentage = convertToPercentage($moisture);
    // Prepare the SQL statement to insert data into the table
    $sql = "INSERT INTO dht_table (temperature, humidity,moisture) VALUES ('$temperature', '$humidity','$moisturePercentage')";
